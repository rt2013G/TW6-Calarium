...
Revision ID: 0162bbc70852
Revises: 
Create Date: 2023-12-21 20:26:02.525865
...
def upgrade():
    ...
    with op.batch_alter_table('crew', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_crew_leader_id'), ['leader_id'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('crew', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_crew_leader_id'))
